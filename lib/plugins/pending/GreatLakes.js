...
//
// const CXR = 'ZK'
// const URL = 'http://greatlakes.booksecure.net/Criteria.aspx';
//
// ////////////////////////////////////////////////////////////////////////////////
//
// module.exports = class GreatLakes extends Website {
//
//   async fetchHtml() {
...
//       page = page
//         .wait(1000)
//         .click('#ctlAvailCriteria_rOneWay')
//         .select('#ctlAvailCriteria_cboOrigin', this.depApt + ' ').wait(500)
//         .select('#ctlAvailCriteria_cboDest', this.arrApt).wait(500)
//         .select('#ctlAvailCriteria_cboDepDay', this.depDate.format('DD')).wait(1000)
//         .select('#ctlAvailCriteria_cboDepMon', this.depDate.format('MM/YYYY')).wait(1000)
//         .click('a#ctlAvailCriteria_lnkNext').wait(5000)
